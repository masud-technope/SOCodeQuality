	...
	\resizebox{3.45in}{!}{%
		\begin{threeparttable}
			\begin{tabular}{l|l|c|c}
				\hline
				\textbf{Topic} & \textbf{Tags} & \textbf{Threads} & \textbf{Selected}\\
				\hline
				Hibernate & \texttt{<java><hibernate>}& & 15\\
				\hline
				Concurrency & \texttt{<java><java.util.concurrent>} & & 05\\
				\hline
				Scanner & \texttt{<java><java.util.scanner>} & & 10\\
				\hline
				Java2D & \texttt{<java><java-2d>}& & 05 \\
				\hline
				Java Beans & \texttt{<java><javabeans>} & & 05\\
				\hline
				Java IO & \texttt{<java><java-io>} & & 10 \\
				\hline
				Java Mail & \texttt{<java><javamail>}& & 05 \\
				\hline
				Java Stream & \texttt{<java><java-stream>}& & 10\\
				\hline
				JAXB & \texttt{<java><jaxb>}& & 15 \\
				\hline
				
				JDBC & \texttt{<java><jdbc>}& & 10 \\
				\hline
			\end{tabular}
		\end{threeparttable}
